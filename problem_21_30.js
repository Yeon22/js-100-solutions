 ...
 * 출력 : MARY
 */
const name24 = prompt("이름을 입력해주세요.");
...
const name26 = prompt("행성 이름을 입력해주세요.");
console.log(planets[name26]);
 ...
 * {'Yujin': 70, 'Hyewon': 100}
 */
const keys = prompt("이름을 공백으로 구분해서 입력해주세요.").split(' ');
const values = prompt("점수를 공백으로 구분해서 입력해주세요.").split(' ');
let obj = {};
 ...
 */
const word29 = prompt("알파벳 하나를 입력하세요.");
if (word29 === word29.toUpperCase()) {
    console.log("YES");
} else {
    console.log("NO");
}
 ...
 * 4
 */
const word30 = "파인애플은 정말 맛있습니다.";
const keyword = "맛"

console.log(word30.indexOf(keyword));